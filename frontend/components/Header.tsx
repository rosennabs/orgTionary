...
export default function Header() {
  ...
  return (
    <header>
      <nav className="relative flex items-center justify-between text-white max-custom-930:text-sm custom-930:text-base px-12 py-8 bg-customTeal w-[100vw]">
        {/* Logo and Brand Name */}
        ...
        {menuOpen && (
          <div className="absolute top-full right-4 bg-gradient-to-b from-cyan-100 to-cyan-300 gap-2 p-4 rounded-lg text-black flex flex-col items-start sm:hidden z-10">
